import {fontString} from "chart.js/dist/helpers.esm";
...
export default function(Chart) {
    ...
    ["pie", "doughnut", "polarArea", "bar"].forEach((t) => {
    ...
    Label.prototype.renderToDataset = function(dataset, index) {
        ...
        arg.meta.data.forEach((element, index) => {
    ...
    Label.prototype.renderToElement = function(dataset, arg, element, index) {
        ...
        const { ctx } = this;
        ctx.save();
        ctx.font = fontString(this.options.fontSize, this.options.fontStyle, this.options.fontFamily);
    ...
    Label.prototype.drawable = function(element, label, renderInfo) {
        ...
        const mertrics = this.measureLabel(label);
        const left = renderInfo.x - mertrics.width / 2;
        const right = renderInfo.x + mertrics.width / 2;
        const top = renderInfo.y - mertrics.height / 2;
        const bottom = renderInfo.y + mertrics.height / 2;
